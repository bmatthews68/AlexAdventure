...
@Component
public class WestIntentHandler extends AbstractMoveIntentHandler {

    @Autowired
    public WestIntentHandler(final PlayerService playerService,
                             final LocationService locationService) {
        super("WestIntent", playerService, locationService);
    }
