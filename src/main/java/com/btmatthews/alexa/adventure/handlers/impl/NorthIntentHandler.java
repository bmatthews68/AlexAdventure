...
@Component
public class NorthIntentHandler extends AbstractMoveIntentHandler {

    @Autowired
    public NorthIntentHandler(final PlayerService playerService,
                              final LocationService locationService) {
        super("NorthIntent", playerService, locationService);
    }
