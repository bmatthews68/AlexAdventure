...
@Component
public class NorthWestIntentHandler extends AbstractMoveIntentHandler {

    @Autowired
    public NorthWestIntentHandler(final PlayerService playerService,
                                  final LocationService locationService) {
        super("NorthWestIntent", playerService, locationService);
    }
