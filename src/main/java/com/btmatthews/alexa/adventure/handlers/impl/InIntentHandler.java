...
@Component
public class InIntentHandler extends AbstractMoveIntentHandler {

    @Autowired
    public InIntentHandler(final PlayerService playerService,
                           final LocationService locationService) {
        super("InIntent", playerService, locationService);
    }
